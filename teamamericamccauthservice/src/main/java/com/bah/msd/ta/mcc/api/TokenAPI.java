...
import com.bah.msd.ta.mcc.domain.CustomerFactory;
import com.bah.msd.ta.mcc.domain.Token;
import com.bah.msd.ta.mcc.util.JWTHelper;
...
public class TokenAPI {
	...
	private Customer getCustomerByNameFromCustomerAPI(String username) {
		try {
			...
			URL url = new URL(apiURL + "/byname/" + username);
